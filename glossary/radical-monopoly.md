...
For the parallel society, radical monopoly is the harder problem than concentrated ownership. A handful of platforms hold radical monopoly over digital social life: opting out is technically possible but socially costly because network effects, search rankings, and default habits have all been built around them. [[Decentralization]] of ownership does not by itself solve this; a decentralised network nobody can find is not a real alternative. [[Counter-economics]] and [[agorism]] are economic strategies in this direction; [[peer-to-peer]] and [[open source]] tools, technical ones. The honest measurement is whether ordinary people can live in the alternative.
