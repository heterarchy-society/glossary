...
A smart contract is a self-executing computer program that runs on a [[blockchain]] network, automatically enforcing and executing the terms of an agreement between parties without the need for intermediaries. First proposed by [[Nick Szabo|people:nick-szabo]] in 1994, smart contracts gained practical implementation with the launch of [[Ethereum]] in 2015, enabling automated, trustless transactions and interactions in a decentralized environment.
