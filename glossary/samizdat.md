...
resources:
  - title: Wikipedia article "Samizdat"
    url: https://en.wikipedia.org/wiki/Samizdat
---
...
Samizdat is one of the clearest historical precedents for [[censorship-resistant|censorship resistance]] information networks. Its architecture anticipates [[p2p|peer-to-peer]] logic: no central point to attack, resilience through redundancy, trust established through social rather than institutional ties. It was foundational infrastructure for the [[parallel society]] — the underground universities, illegal publishers, and autonomous networks that dissidents built outside the reach of the state. Its descendants are [[shadow library|shadow libraries]], encrypted file sharing, and any system designed so that suppressing information requires suppressing every person who holds a copy.
